...
import { AlertCircle, CheckCircle, Clock, Download, Eye, Plus, Trash2, Upload, Wand2 } from "lucide-react";
        ...
        <Card className="border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div>
                <Label htmlFor="resize">Resolução</Label>
                <Select value={globalSettings.resize} onValueChange={(value) => 
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="1080x1920">1080x1920 (Stories)</SelectItem>
